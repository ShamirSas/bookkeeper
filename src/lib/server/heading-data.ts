import { DateInput, Heading, HeadingId, HeadingParams, NumberInput, TextInput } from '$lib/types';
...
export const headings: Heading[] = [
	...
	new Heading(HeadingId.Type, new HeadingParams('Type'), { inputClass: TextInput }),
	new Heading(HeadingId.Premium, new HeadingParams('PREMIUM'), {
		inputClass: NumberInput,
		inputClassParams: { prefix: 'R' }
	}),
